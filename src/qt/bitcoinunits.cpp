...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZEEP");
    case mBTC: return QString("mZEEP");
    case uBTC: return QString::fromUtf8("μZEEP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ZEEPs"));
    case mBTC: return QString(QObject::tr("Milli-ZEEPs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ZEEPs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
